...
mod130.1.0 = gam(shannonH ~ s(mean_gapsize, k=3) +
                         s(sd_gapsize, k=3) +
                         s(mean_stdpeakh, k=3) +
                         s(meanH_plot, k=3) +
...
summary(mod130.1.0)
p130.1.0 = draw(mod130.1.0, residuals = TRUE)
p130.1.0

ggsave(plot = p130.1.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-1-0_PartialEffects_", radius ,"mRadius_mango.png"),
       width = 14, height = 8, units = "in", device='png', dpi=300)

a130.1.0 = appraise(mod130.1.0)
a130.1.0

ggsave(plot = a130.1.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-1-0_Appraise_", radius ,"mRadius_mango.png"),
       width = 12, height = 8, units = "in", device='png', dpi=300)

gam.check(mod130.1.0, rep=500)
...
summary(mod130.2.0)
p130.2.0 = draw(mod130.2.0, residuals = TRUE)
p130.2.0

ggsave(plot = p130.2.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-2-0_PartialEffects_", radius ,"mRadius_mango.png"),
       width = 14, height = 8, units = "in", device='png', dpi=300)

a130.2.0 = appraise(mod130.2.0)
a130.2.0

ggsave(plot = a130.2.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-2-0_Appraise_", radius ,"mRadius_mango.png"),
       width = 12, height = 8, units = "in", device='png', dpi=300)

gam.check(mod130.2.0, rep=500)
lines(c(3.0, 3.8), c(3.0, 3.8))
...
summary(mod130.3.0)
p130.3.0 = draw(mod130.3.0, residuals = TRUE)
p130.3.0

ggsave(plot = p130.3.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-3-0_PartialEffects_", radius ,"mRadius_mango.png"),
       width = 14, height = 8, units = "in", device='png', dpi=300)

a130.3.0 = appraise(mod130.3.0)
a130.3.0

ggsave(plot = a130.3.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-3-0_Appraise_", radius ,"mRadius_mango.png"),
       width = 12, height = 8, units = "in", device='png', dpi=300)

gam.check(mod130.3.0, rep=500)
lines(c(3.0, 3.8), c(3.0, 3.8))

# # # FINAL Models and Plots

mod130.4.0 = gam(shannonH ~
                   s(sd_gapsize, k=5) +
                   s(VDRpeak_plot, k=5) +
                   s(X,Y, k=5),
                 data=XY_scale,
...
summary(mod130.4.0)
p130.4.0 = draw(mod130.4.0, residuals = TRUE)
p130.4.0

ggsave(plot = p130.4.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-4-0_PartialEffects_", radius ,"mRadius_mango.png"),
       width = 14, height = 8, units = "in", device='png', dpi=300)

a130.4.0 = appraise(mod130.4.0)
a130.4.0

ggsave(plot = a130.4.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-4-0_Appraise_", radius ,"mRadius_mango.png"),
       width = 12, height = 8, units = "in", device='png', dpi=300)

gam.check(mod130.4.0, rep=500)
lines(c(3.0, 3.8), c(3.0, 3.8))

# Compute RMSE
mod130.4.0_RMSE = sqrt(mean(mod130.4.0$residuals**2))

# Same some important results
vartbl_mod130.4.0 = tidy(mod130.4.0)
write_csv(vartbl_mod130.4.0,
          paste0(tabled, '/VarTable_Shannon130-4-0_', radius, 'mRadius.csv'))

# use sink to save summary outputs in a txt file

sink(paste0(tabled, '/ModelSummary_Shannon130-4-0_', radius, 'mRadius.txt'))
summary(mod130.4.0)
print(paste0("AIC = ", mod130.4.0$aic))
print(paste0("RMSE = ", mod130.4.0_RMSE))
sink()


# get prediction values with SE 
p = as_tibble(predict(mod130.4.0, se.fit = TRUE))
...
XYplot
# LOL was going to save this one but the plot is incredibly wonky. Use 5.0 below. 


# # # 

# note: adding cvH helps, but there's not much to justify using it
# MICorr flagged it as a good variable to use
# s(mean_cvH, k=5) +
...
ggsave(plot = p130.5.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-5-0_PartialEffects_", radius ,"mRadius_mango.png"),
       width = 14, height = 8, units = "in", device='png', dpi=300)
...
ggsave(plot = a130.5.0,
       filename=paste0(figd,
                       "/GAMs/GAM-130-5-0_Appraise_", radius ,"mRadius_mango.png"),
       width = 12, height = 8, units = "in", device='png', dpi=300)
...
write_csv(vartbl_mod130.5.0,
          paste0(tabled, '/VarTable_Shannon130-5-0_', radius, 'mRadius.csv'))

# use sink to save summary outputs in a txt file

sink(paste0(tabled, '/ModelSummary_Shannon130-5-0_', radius, 'mRadius.txt'))
summary(mod130.5.0)
...
ggsave(plot = XYplot,
       filename=paste0(figd,
                       "/GAMs/GAM-130-5-0_XYplot_", radius ,"mRadius_mango.png"),
...
ggsave(plot = p1to1,
       filename=paste0(figd,
                       "/GAMs/GAM-130-5-0_1to1Plot_", radius ,"mRadius_mango.png"),
       width = 9, height = 6, units = "in", device='png', dpi=300)
